    ...
    <div className="dash">
      <aside className="dash-sidebar">
        ...
        <div className="dash-sidebar__user">
          ...
          <div className="dash-sidebar__user-meta">
            ...
            <div className="dash-sidebar__user-role">{role}</div>
          </div>
        </div>

        <nav className="dash-sidebar__nav">
          <span className="dash-sidebar__section-label">Organizer Panel</span>
      ...
      <div className="dash-main">
        <header className="dash-topbar">
          ...
          <Link to="/" className="dash-topbar__home">
            Home
          </Link>
        </header>
